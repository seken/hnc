...
/**
 * @file
 * @brief Just for operator<<(std::ostream & o, hnc::ga::solution_grade<solution_t, grade_t> const & solution)
 */
			...
			void crossover_and_mutation()
			{
				...
				for (std::size_t archipelago = 0; archipelago < m_solutions_grades.size(); ++archipelago)
				{
					...
					for (std::size_t island = 0; island < m_solutions_grades[archipelago].size(); ++island)
					{
						...
						hnc::ga::island<solution_grade<solution_t, grade_t>> new_generation;
...
/**
 * Display a hnc::ga::solution_grade<solution_t, grade_t>
 * @param o        Out stream
 * @param solution A solution
 * @return the out stream
 */
template <class solution_t, class grade_t>
std::ostream & operator<<(std::ostream & o, hnc::ga::solution_grade<solution_t, grade_t> const & solution)
{
