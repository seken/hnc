...
/**
 * @file
 * @brief Just for std::ostream & operator<<(std::ostream & o, hnc::gnuplot::plot const & plot)
 */
...
namespace hnc
{
	namespace gnuplot
	{
		...
		/**
		 * @brief Display a hnc::gnuplot::plot
		 *
		 ...
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::plot const & plot)
		{
			o << plot.plot_line();
			return o;
		}
