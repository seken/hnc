...
/**
 * @file
 * @brief Just for http://www.gnuplotting.org/output-terminals/ and operator<< between std::ostream and the differents hnc::gnuplot::output_terminal
 */
...
namespace hnc
{
	namespace gnuplot
	{
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_png
		 *
		 ...
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_png const & output_terminal)
		{
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_svg
		 *
		 * @param[out] o              Out stream
		 ...
		 * @return the out stream
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_svg const & output_terminal)
		{
			o << output_terminal.to_string();
			return o;
		}
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_pdf
		 *
		 * @param[out] o              Out stream
		 ...
		 * @return the out stream
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_pdf const & output_terminal)
		{
			o << output_terminal.to_string();
			return o;
		}
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_postscript
		 *
		 * @param[out] o              Out stream
		 ...
		 * @return the out stream
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_postscript const & output_terminal)
		{
			o << output_terminal.to_string();
			return o;
		}
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_epslatex
		 *
		 * @param[out] o              Out stream
		 ...
		 * @return the out stream
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_epslatex const & output_terminal)
		{
			o << output_terminal.to_string();
			return o;
		}
		...
		/**
		 * @brief Display a hnc::gnuplot::output_terminal_wxt
		 *
		 * @param[out] o              Out stream
		 ...
		 * @return the out stream
		 */
		std::ostream & operator<<(std::ostream & o, hnc::gnuplot::output_terminal_wxt const & output_terminal)
		{
			o << output_terminal.to_string();
			return o;
		}
