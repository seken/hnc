...
#include <hnc/openmp/run_at_same_time.hpp>
...
int main()
{
	...
	hnc::openmp::run_at_same_time(fct);
	std::cout << std::endl;

	std::cout << "Use fonction, functor object:" << std::endl;
	hnc::openmp::run_at_same_time(fct, obj_fct);
	std::cout << std::endl;

	std::cout << "Use fonction, functor object, lambda function:" << std::endl;
	hnc::openmp::run_at_same_time(fct, obj_fct, lambda_fct);
	std::cout << std::endl;

	std::cout << "Use fonction, functor object, lambda function, fonction:" << std::endl;
	hnc::openmp::run_at_same_time(fct, obj_fct, lambda_fct, fct);
	std::cout << std::endl;

	std::cout << "Use fonction, functor object, lambda function, fonction, functor object:" << std::endl;
	hnc::openmp::run_at_same_time(fct, obj_fct, lambda_fct, fct, obj_fct);
	std::cout << std::endl;

	std::cout << "Use fonction, functor object, lambda function, fonction, functor object, lambda function:" << std::endl;
	hnc::openmp::run_at_same_time(fct, obj_fct, lambda_fct, fct, obj_fct, lambda_fct);
	std::cout << std::endl;

	hnc::test::warning(nb_test == 0, "hnc::openmp::run_at_same_time: " + hnc::to_string(nb_test) + " test fail!\n");
