...
int main()
{
	...
	// Create population
	hnc::ga::genetic_algo<std::string, unsigned int, search_a_word> ga
	(
		evolve_functions,
		2,                                 // nb_archipelago,
		...
		hnc::ga::minimal_plus_log,         // log_level = no_log, minimal_log, minimal_plus_log, archipelago_log, island_log, solution_grade_log
		1,                                 // nb_generation_between_copy_best_solution = 1
		hnc::ga::system_clock_now          // std::function<unsigned int ()> const & generate_seed = system_clock_now()
	);
	// Star genetic algo
	ga.evolve();
