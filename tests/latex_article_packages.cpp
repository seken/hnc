...
int main()
{
...

	{
		...
		latex_article.use_package("url");
		latex_article.use_package("verbatim", "listings");
		latex_article.use_package("graphics", "wrapfig", "subfig");
		std::cout << latex_article << std::endl;

		std::ofstream f("hnc_latex_article_packages.tex");
