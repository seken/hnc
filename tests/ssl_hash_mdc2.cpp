...
int main()
{
	...
	// You can test return with: echo -n "Compute mdc2" | openssl mdc2
	...
	hnc::test::warning(nb_test == 0, "hnc::ssl::hash::mdc2: " + hnc::to_string(nb_test) + " test fail!\n");
