...
int main()
{
	...
	++nb_test;
	{
		...
		(
			...
			"hnc::rectangle " + hnc::to_string(r) + " fails\n"
		);
	}

	++nb_test;
	{
		hnc::rectangle<int> r(0, 0, 10, 10);
		std::cout << r << std::endl;
		nb_test -= hnc::test::warning
		(
	...
	++nb_test;
	{
		hnc::rectangle<unsigned int> r(5, 7, 10, 3);
		std::cout << r << std::endl;
		nb_test -= hnc::test::warning
		(
	...
	++nb_test;
	{
		hnc::rectangle<int> r0(1, 2, 3, 4);
		hnc::rectangle<int> r1(1, 2, 3, 4);
		std::cout << r0 << std::endl;
		std::cout << r1 << std::endl;
		nb_test -= hnc::test::warning
		(
			r0 == r1 && ((r0 != r1) == false),
			"hnc::rectangle " + hnc::to_string(r0) + " comparaison fails\n"
		);
	}

	++nb_test;
	{
		hnc::rectangle<int> r0(1, 1, 1, 1);
		hnc::rectangle<int> r1(1, 1, 1, 2);
		std::cout << r0 << std::endl;
		std::cout << r1 << std::endl;
		nb_test -= hnc::test::warning
		(
	...
	hnc::test::warning(nb_test == 0, "hnc::rectangle: " + hnc::to_string(nb_test) + " test fail!\n");
